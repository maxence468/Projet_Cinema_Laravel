...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 11 déc. 2025 à 12:46
...
--
-- Base de données : `p2025_2sio_projet_cineforall`
--
...
CREATE TABLE IF NOT EXISTS `casting` (
  ...
  `nomJoue` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `preJoue` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `principale` tinyint(1) NOT NULL,
  `secondaire` tinyint(1) NOT NULL,
  PRIMARY KEY (`film_id`,`pers_id`),
  KEY `casting_pers_id_foreign` (`pers_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cinemas` (
  `idCinema` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `nomCinema` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresseCinema` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `codePostale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `films` (
  `idFilm` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `titreFilm` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descFilm` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `dateSortieFilm` date NOT NULL,
  `dureeFilm` int NOT NULL,
  `posterFilm` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `idGenre` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idFilm`),
  KEY `films_idgenre_foreign` (`idGenre`)
...
CREATE TABLE IF NOT EXISTS `film_realisateur` (
  ...
  `pers_id` bigint UNSIGNED NOT NULL,
  PRIMARY KEY (`film_id`,`pers_id`),
  KEY `film_realisateur_pers_id_foreign` (`pers_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `film_scenariste`
--

DROP TABLE IF EXISTS `film_scenariste`;
CREATE TABLE IF NOT EXISTS `film_scenariste` (
  `film_id` bigint UNSIGNED NOT NULL,
  `pers_id` bigint UNSIGNED NOT NULL,
  PRIMARY KEY (`film_id`,`pers_id`),
  KEY `film_scenariste_pers_id_foreign` (`pers_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `film_scenariste`
--
...
CREATE TABLE IF NOT EXISTS `genres` (
  ...
  `libGenre` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idGenre`)
...
CREATE TABLE IF NOT EXISTS `personnes` (
  `idPers` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `nomPers` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prePers` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dateNaissPers` date NOT NULL,
  `lieuNaissPers` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `photoPers` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `salles` (
  `idSalle` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `capaciteSal` int NOT NULL,
  `idTypeSalle` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `idCinema` bigint UNSIGNED NOT NULL,
  PRIMARY KEY (`idSalle`),
  KEY `salles_idcinema_foreign` (`idCinema`),
  KEY `salles_idtypesalle_foreign` (`idTypeSalle`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `salle_tarif`
--

DROP TABLE IF EXISTS `salle_tarif`;
CREATE TABLE IF NOT EXISTS `salle_tarif` (
  `idSalle` bigint UNSIGNED NOT NULL,
  `idTarif` bigint UNSIGNED NOT NULL,
  PRIMARY KEY (`idSalle`,`idTarif`),
  KEY `salle_tarif_idtarif_foreign` (`idTarif`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `salle_tarif`
--
...
CREATE TABLE IF NOT EXISTS `seances` (
  `idSeance` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `heureSeance` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tarifs` (
  `idTarif` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `libTarif` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prixTarif` decimal(8,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idTarif`)
...
CREATE TABLE IF NOT EXISTS `typesalles` (
  `idTypeSalle` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `libTypeSalle` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prixTypeSalle` decimal(8,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
