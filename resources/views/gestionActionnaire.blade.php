                    ...
                    <form id="myForm" method="post" action="">
                        ...
                        <div class="row mb-1">
                            <div class="col-12 col-lg-7 order-1">
                                <h3 class="mb-3 pt-4 pb-4">Ajouter, modifier ou supprimer un actionnaire</h3>
                            </div>

                            <div class="col-12 col-lg-5 order-2 d-lg-flex justify-content-center mt-5">
                                <div class="alignment-wrapper mt-4">
                                    <label class="h3" for="listeSalle">Actionnaire à modifier</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-4 pt-3">
                            <div class="col-12 col-lg-3 order-4 order-lg-3">
                                <label class="h3 mb-0">Nom actionnaire</label>
                            </div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-12 col-lg-3 order-4 order-lg-3">
                                <label class="h3 mb-0">Prenom actionnaire</label>
                            </div>

                            <div class="col-12 col-lg-4 order-5 order-lg-4">
                                <input class="inputCatalogue" id="libGenre" type="text" placeholder="Prenom actionnaire" required>
                            </div>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-12 col-lg-3">
                                <label class="h3 mb-0">Argent investi</label>
                            </div>
                            <div class="col-12 col-lg-4">
                                <input id="capaciteSal" class="inputCatalogue" type="number" min="1" max="1000" step="1"
                                       title="La capacité de la salle doit être entre 1 et 1000" placeholder="Argent investi" required>
                            </div>
                            <div class="col-lg-5 d-none d-lg-block"></div>
                        </div>
                        <div>
